...
class TypeTask(models.Model):
    ...
    created_user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Создатель типа задачи')


class TaskList(models.Model):
    title = models.CharField(max_length=128, verbose_name='Заголовок списка')
    created_user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Создатель списка задач')
...
class TodoTask(models.Model):
    ...
    created_user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Создатель задачи')
    assigned_user = models.ManyToManyField(User, null=True, blank=True, verbose_name='Назначенный сотрудник', related_name='assigned_users')
    todo_task = models.ForeignKey(TaskList, null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Список задач')
